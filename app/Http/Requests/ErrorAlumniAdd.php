...
class ErrorAlumniAdd extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'data_excel' => 'required|file|unique:alumnis|mimes:xls,xlt,xlsx,xlsb,xlsm,xltx,xltm',
    ...
    public function messages(){
        return [
            ...
            'data_excel.required' => 'Data file excel tidak boleh kosong',
            'data_excel.unique' => 'File sudah tersedia',
