...
!(function (t, e) {
  ...
  function k(t) {
    const e = t.r / 255,
      ...
      a = (n + o) / 2;
    let r, l, h;
    return n !== o && ((h = n - o), (l = a > 0.5 ? h / (2 - n - o) : h / (n + o)), (r = n === e ? (i - s) / h + (i < s ? 6 : 0) : n === i ? (s - e) / h + 2 : (e - i) / h + 4), (r = 60 * r + 0.5)), [0 | r, l || 0, a];
  }
  function S(t, e, i, s) {
  ...
  function Te(t, e, i, s, n) {
    ...
    return (
      Oe(t, i, e, function (i, l, h) {
        ...
        const u = a(e, d);
        u < r ? ((o = [{element: i, datasetIndex: l, index: h}]), (r = u)) : u === r && o.push({element: i, datasetIndex: l, index: h});
      }),
      o
    );
  }
  ...
  function He(t, e) {
    ...
    const n = {family: K(t.family, e.family), lineHeight: Fe(K(t.lineHeight, e.lineHeight), i), size: i, style: s, weight: K(t.weight, e.weight), string: ""};
      ...
      const n = Ne(t.options.layout.padding),
        ...
        r = (function (t) {
          const e = (function (t) {
            ...
            r = qe(e, "x"),
            l = qe(e, "y");
          return {fullSize: i, leftAndTop: s.concat(o), rightAndBottom: n.concat(l).concat(a).concat(r), chartArea: Xe(e, "chartArea"), vertical: s.concat(n).concat(l), horizontal: o.concat(a).concat(r)};
        })(t.boxes),
        l = r.vertical,
        h = r.horizontal;
      Q(t.boxes, (t) => {
  ...
  function oi(t, e = [""], i = t, s, n = () => t[0]) {
    ...
    const o = {[Symbol.toStringTag]: "Object", _cacheable: !0, _scopes: t, _rootScopes: i, _fallback: s, _getTarget: n, override: (n) => oi([n, ...t], e, i, s)};
    return new Proxy(o, {
  ...
  function ai(t, e, i, s) {
    const n = {_cacheable: !1, _proxy: t, _context: e, _subProxy: i, _stack: new Set(), _descriptors: ri(t, s), setContext: (e) => ai(t, e, i, s), override: (n) => ai(t.override(n), e, i, s)};
    return new Proxy(n, {
  ...
  function Fi(t) {
    return "angle" === t ? {between: Ht, compare: Wt, normalize: Nt} : {between: Yt, compare: (t, e) => t - e, normalize: (t) => t};
  }
  ...
  function Vi(t, e, i) {
    ...
    for (let t = c, i = c; t <= d; ++t)
      (m = e[t % a]),
        m.skip || ((p = h(m[s])), p !== x && ((b = l(p, n, o)), null === _ && y() && (_ = 0 === r(p, n) ? t : i), null !== _ && v() && (g.push(Bi({start: _, end: t, loop: u, count: a, style: f})), (_ = null)), (i = t), (x = p)));
    ...
    acquireContext(t, e) {
      ...
      return i && i.canvas === t
        ? ((function (t, e) {
            ...
            if (((t.$chartjs = {initial: {height: s, width: n, style: {display: i.display, height: i.height, width: i.width}}}), (i.display = i.display || "block"), (i.boxSizing = i.boxSizing || "border-box"), Ki(n))) {
              const e = Pe(t, "width");
              void 0 !== e && (t.width = e);
            }
            if (Ki(s))
  ...
  bt.describe("animation", {_fallback: !1, _indexable: !1, _scriptable: (t) => "onProgress" !== t && "onComplete" !== t && "fn" !== t}),
    bt.set("animations", {colors: {type: "color", properties: ["color", "borderColor", "backgroundColor"]}, numbers: {type: "number", properties: ["x", "y", "borderWidth", "radius", "tension"]}}),
      ...
      if (t >= 0 && t < this._cachedMeta.data.length) {
        ...
        (n =
          ...
          (e.$context = (function (t, e, i) {
            return Ye(t, {active: !1, dataIndex: e, parsed: void 0, raw: void 0, element: i, index: e, mode: "default", type: "data"});
          })(this.getContext(), t, e))),
  ...
  bt.set("scale", {
    ...
    bt.describe("scale", {_fallback: !1, _scriptable: (t) => !t.startsWith("before") && !t.startsWith("after") && "callback" !== t && "parser" !== t, _indexable: (t) => "borderDash" !== t && "tickBorderDash" !== t}),
    bt.describe("scales", {_fallback: "scale"}),
    bt.describe("scale.ticks", {_scriptable: (t) => "backdropPadding" !== t && "callback" !== t, _indexable: (t) => "backdropPadding" !== t});
  ...
  class Bs extends Ds {
    ...
    getUserBounds() {
      ...
      return (t = q(t, Number.POSITIVE_INFINITY)), (e = q(e, Number.NEGATIVE_INFINITY)), (i = q(i, Number.POSITIVE_INFINITY)), (s = q(s, Number.NEGATIVE_INFINITY)), {min: q(t, i), max: q(e, s), minDefined: X(t), maxDefined: X(e)};
    }
    getMinMax(t) {
      let e,
  ...
  class dn {
    ...
    _resize(t, e) {
      ...
      (this.width = o.width),
        ...
        (this._aspectRatio = this.aspectRatio),
        ke(this, a, !0) && (this.notifyPlugins("resize", {size: o}), J(i.onResize, [this, o], this), this.attached && this._doResize(r) && this.render());
    }
    ensureScalesHaveIDs() {
    ...
    buildOrUpdateControllers() {
      ...
      for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
        ...
        if (
          ...
          Object.assign(e.prototype, {dataElementType: Ws.getElement(a), datasetElementType: s && Ws.getElement(s)}), (n.controller = new e(this, i)), t.push(n.controller);
        }
      }
    ...
    _drawDataset(t) {
      ...
      !1 !== this.notifyPlugins("beforeDatasetDraw", o) &&
        (s && Qt(e, {left: !1 === i.left ? 0 : n.left - i.left, right: !1 === i.right ? this.width : n.right + i.right, top: !1 === i.top ? 0 : n.top - i.top, bottom: !1 === i.bottom ? this.height : n.bottom + i.bottom}),
        t.controller.draw(),
        s && te(e),
        (o.cancelable = !1),
  ...
  class Sn extends Ps {
    ...
    _getRuler() {
      ...
      return {min: a || xn(e), pixels: s, start: i._startPixel, end: i._endPixel, stackCount: this._getStackCount(), scale: i, grouped: t.grouped, ratio: a ? 1 : t.categoryPercentage * t.barPercentage};
    }
  ...
  (Sn.id = "bar"),
    (Sn.defaults = {datasetElementType: !1, dataElementType: "bar", categoryPercentage: 0.8, barPercentage: 0.9, grouped: !0, animations: {numbers: {type: "number", properties: ["x", "y", "base", "width", "height"]}}}),
    (Sn.overrides = {scales: {_index_: {type: "category", offset: !0, grid: {offset: !0}}, _value_: {type: "linear", beginAtZero: !0}}});
  class Pn extends Ps {
    initialize() {
      (this.enableOptionSharing = !0), super.initialize();
    }
  ...
  (Pn.id = "bubble"),
    (Pn.defaults = {datasetElementType: !1, dataElementType: "point", animations: {numbers: {type: "number", properties: ["x", "y", "borderWidth", "radius"]}}}),
    (Pn.overrides = {scales: {x: {type: "linear"}, y: {type: "linear"}}, plugins: {tooltip: {callbacks: {title: () => ""}}}});
  class Dn extends Ps {
    constructor(t, e) {
  ...
  (Ln.id = "scatter"),
    ...
    (Ln.overrides = {interaction: {mode: "point"}, plugins: {tooltip: {callbacks: {title: () => "", label: (t) => "(" + t.label + ", " + t.formattedValue + ")"}}}, scales: {x: {type: "linear"}, y: {type: "linear"}}});
  ...
  function In(t, e, i, s) {
    ...
    return {outerStart: r(n.outerStart), outerEnd: r(n.outerEnd), innerStart: jt(n.innerStart, 0, a), innerEnd: jt(n.innerEnd, 0, a)};
  }
  function zn(t, e, i, s) {
  ...
  class Vn extends Ds {
    ...
    draw(t) {
      const {options: e, circumference: i} = this,
        s = (e.offset || 0) / 2,
        n = (e.spacing || 0) / 2;
      if (((this.pixelMargin = "inner" === e.borderAlign ? 0.33 : 0), (this.fullCircles = i > yt ? Math.floor(i / yt) : 0), 0 === i || this.innerRadius < 0 || this.outerRadius < 0)) return;
      t.save();
      let o = 0;
      if (s) {
        o = s / 2;
    ...
    Un && !e.options.segment
      ...
      : (function (t, e, i, s) {
          const {segments: n, options: o} = e,
            a = Yn(e);
          for (const r of n) Wn(t, o, r.style), t.beginPath(), a(t, e, r, {start: i, end: i + s - 1}) && t.closePath(), t.stroke();
        })(t, e, i, s);
  }
  class qn extends Ds {
    constructor(t) {
  ...
  (qn.id = "line"),
    (qn.defaults = {borderCapStyle: "butt", borderDash: [], borderDashOffset: 0, borderJoinStyle: "miter", borderWidth: 3, capBezierPoints: !0, cubicInterpolationMode: "default", fill: !1, spanGaps: !1, stepped: !1, tension: 0}),
  ...
  class Gn extends Ds {
    ...
    draw(t, e) {
      const i = this.options;
      this.skip || i.radius < 0.1 || !Jt(this, e, this.size(i) / 2) || ((t.strokeStyle = i.borderColor), (t.lineWidth = i.borderWidth), (t.fillStyle = i.backgroundColor), Zt(t, i, this.x, this.y));
    }
    getRange() {
      const t = this.options || {};
    ...
    const e = Zn(t),
      ...
      n = (function (t, e, i) {
        const s = t.options.borderWidth,
          n = t.borderSkipped,
          o = Ve(s);
        return {t: Jn(n.top, o.top, 0, i), r: Jn(n.right, o.right, 0, e), b: Jn(n.bottom, o.bottom, 0, i), l: Jn(n.left, o.left, 0, e)};
      })(t, i / 2, s / 2),
      o = (function (t, e, i) {
    ...
    beforeElementsUpdate: (t, e, i) => {
      ...
      t.data.datasets.forEach((e, n) => {
        ...
        let {start: c, count: d} = (function (t, e) {
          ...
          return l && (n = jt(re(e, o.axis, a).lo, 0, i - 1)), (s = h ? jt(re(e, o.axis, r).hi + 1, n, i) - n : i - n), {start: n, count: s};
        })(r, l);
  ...
  function co(t) {
    return (t.scale || {}).getPointPositionForValue
      ? (function (t) {
          ...
          let l, h, c;
          if (((c = "start" === i ? a : "end" === i ? r : U(i) ? i.value : e.getBaseValue()), s.grid.circular)) return (h = e.getPointPositionForValue(0, a)), new ho({x: h.x, y: h.y, radius: e.getDistanceFromCenterForValue(c)});
      ...
      : (function (t) {
          ...
          let s,
            n = null;
          return "start" === i ? (n = e.bottom) : "end" === i ? (n = e.top) : U(i) ? (n = e.getPixelForValue(i.value)) : e.getBasePixel && (n = e.getBasePixel()), X(n) ? ((s = e.isHorizontal()), {x: s ? n : null, y: s ? null : n}) : null;
        })(t);
  }
  function uo(t, e, i) {
    for (; e > t; e--) {
        ...
        for (const t of s) {
          ...
          for (const e of h) {
            const s = _o(i, o[e.start], o[e.end], e.loop),
              r = Vi(t, n, s);
            for (const t of r) a.push({source: t, target: e, start: {[i]: yo(l, s, "start", Math.max)}, end: {[i]: yo(l, s, "end", Math.min)}});
          }
        }
        return a;
      })(i, s, n);
  ...
  function ko(t, e, i) {
    ...
    s &&
      ...
      (function (t, e) {
        ...
        t.save(), "x" === l && o !== n && (bo(t, s, a.top), Mo(t, {line: i, target: s, color: n, scale: r, property: l}), t.restore(), t.save(), bo(t, s, a.bottom)), Mo(t, {line: i, target: s, color: o, scale: r, property: l}), t.restore();
    ...
    afterDatasetsUpdate(t, e, i) {
      ...
      for (a = 0; a < s; ++a)
        (o = t.getDatasetMeta(a)),
          (r = o.dataset),
          (l = null),
          r && r.options && r instanceof qn && (l = {visible: t.isDatasetVisible(a), index: a, fill: lo(r, a, s), chart: t, axis: o.controller.options.indexAxis, scale: o.vScale, line: r}),
          (o.$filler = l),
          n.push(l);
  ...
  class Oo extends Ds {
    ...
    _drawArgs(t) {
      ...
      let l,
        ...
        d = 0;
      return (
        this.isHorizontal() ? ((h = n(r, i, o)), (c = e + t), (l = o - i)) : ("left" === a.position ? ((h = i + t), (c = n(r, s, e)), (d = -0.5 * _t)) : ((h = o - t), (c = n(r, e, s)), (d = 0.5 * _t)), (l = s - e)),
    ...
    draw() {
      ...
      se(t, e.text, 0, 0, i, {color: e.color, maxWidth: r, rotation: l, textAlign: s(e.align), textBaseline: "middle", translation: [o, a]});
    }
  }
  var Ao = {
    id: "title",
  ...
  function Wo(t, e, i, s) {
    ...
    return "center" === l ? ("left" === r ? (g += h) : "right" === r && (g -= h)) : "left" === r ? (g -= Math.max(c, u) + n) : "right" === r && (g += Math.max(d, f) + n), {x: jt(g, 0, s.width - e.width), y: jt(p, 0, s.height - e.height)};
  }
  function No(t, e, i) {
  ...
  class $o extends Ds {
    ...
    getContext() {
      return this.$context || (this.$context = ((t = this.chart.getContext()), (e = this), (i = this._tooltipItems), Ye(t, {tooltip: e, tooltipItems: i, type: "tooltip"})));
      var t, e, i;
    }
    getTitle(t, e) {
      const {callbacks: i} = e,
    ...
    drawBody(t, e, i) {
      ...
      let m, x, b, _, y, v, w;
      for (
        e.textAlign = o, e.textBaseline = "middle", e.font = c.string, t.x = No(this, p, i), e.fillStyle = i.bodyColor, Q(this.beforeBody, g), u = a && "right" !== p ? ("center" === o ? l / 2 + h : l + 2 + h) : 0, _ = 0, v = s.length;
        _ < v;
        ++_
      ) {
    ...
    draw(t) {
      ...
      e.enabled &&
        a &&
        (t.save(), (t.globalAlpha = i), this.drawBackground(n, t, s, e), Ii(t, e.textDirection), (n.y += o.top), this.drawTitle(n, t, e), this.drawBody(n, t, e), this.drawFooter(n, t, e), zi(t, e.textDirection), t.restore());
    }
    getActiveElements() {
      return this._active || [];
    }
        ...
        (e.pointLabels.display &&
          (function (t, e) {
            ...
            for (let n = e - 1; n >= 0; n--) {
              ...
              se(i, t._pointLabels[n], a, r + o.lineHeight / 2, o, {color: e.color, textAlign: l, textBaseline: "middle"});
            }
          })(this, n),
        s.display &&
            ...
            if (0 !== e) {
              ...
              !(function (t, e, i, s) {
                ...
                (!o && !s) ||
                  ...
                  !r ||
                  i < 0 ||
                  (n.save(), (n.strokeStyle = a), (n.lineWidth = r), n.setLineDash(e.borderDash), (n.lineDashOffset = e.borderDashOffset), n.beginPath(), ra(t, i, o, s), n.closePath(), n.stroke(), n.restore());
  ...
  (la.id = "radialLinear"),
    ...
    (la.defaultRoutes = {"angleLines.color": "borderColor", "pointLabels.color": "color", "ticks.color": "color"}),
