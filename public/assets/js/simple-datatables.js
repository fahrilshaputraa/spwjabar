            ...
            add(t) {
              ...
              this.dt.hiddenHeader ? (s.innerHTML = "") : t.heading.nodeName ? s.appendChild(t.heading) : (s.innerHTML = t.heading),
                ...
                this.dt.data.forEach((s, i) => {
                  t.data[i] &&
                    ((e = document.createElement("td")), t.data[i].nodeName ? e.appendChild(t.data[i]) : (e.innerHTML = t.data[i]), (e.data = e.innerHTML), t.render && (e.innerHTML = t.render.call(this, e.data, e, s)), s.appendChild(e));
                }),
          ...
          const r = function (t) {
            ...
            l = {
              ...
              labels: {
                ...
                perPage: "{select} Perhalaman",
                noRows: "Tidak ada inputan yang ditemukan",
                noResults: "Tidak ada hasil yang cocok dengan pencarian anda",
                info: "Menampilkan {start} sampai {end} dari {rows} Inputan",
              },
          ...
          class o {
            ...
            render(t) {
              ...
              if (
                ...
                (i += "<div class='dataTable-top mt-3 d-flex justify-content-between'>"),
                (i += s.layout.top),
                (i += "</div>"),
                s.scrollY.length ? (i += `<div class='dataTable-container' style='height: ${s.scrollY}; overflow-Y: auto;'></div>`) : (i += "<div class='dataTable-container table-responsive'></div>"),
                ...
                const a = e("select", {class: "dataTable-selector me-1"});
              ...
              if (s.searchable) {
                const t = `<div class='dataTable-search d-flex align-items-center col-xxl-2 order-1'><i class='bx ri-search-line icon-search'></i><input class='dataTable-input w-100' placeholder='${s.labels.placeholder}' type='text'></div>`;
