                          ...
                          <div class="header-tabel">
                            <div class="row title-table align-items-center">
                              ...
                              <div class="col btn-tamimport d-flex gap-1 justify-content-end">
                                ...
                                <a href="/disdik/export/siswa" class="btn btn-dark"
                                style="--bs-btn-padding-y: .35rem; --bs-btn-padding-x: 1rem; --bs-btn-font-size: .78rem;">
                            ...
                            <table class="table datatable border">
                               ...
                               <tbody>
                                ...
                                <tr id="{{ $d->nisn }}">
                                   ...
                                   <td class="text-field">{{ $d->omset }}</td>
                                   <td class="text-field">{{ $d->nib }}</td>
                                   <td class="text-field">{{ $d->tahun_rekap }}</td>
                                   <td class="text-field">
                                    @if ($d->laporan_keuangan)
                                      <a href="/Laporan Keuangan/{{ $d->laporan_keuangan }}" target="_blank">Lihat</a>
                                    @else
                                      Belum tersedia
                                    @endif
                                  </td>
                                   <td class="text-field">
                                    @if ($d->deskripsi_produk && $d->foto_produk && $d->link_produk)
                                      <a data-bs-toggle="modal" data-bs-target="#lihatProduk" class="text-warning" onclick="lihatProduk('{{ $d->nisn }}')">Lihat</a>
                                    @else
                                      Belum tersedia
                                    @endif
                                  </td>
                  ...
                  <div class="modal-dialog modal-dialog-scrollable">
                      <div class="modal-content">
                          ...
                          <div class="modal-body">
                              <form class="row g-3" action="/disdik/siswa/store" method="POST" enctype="multipart/form-data">
                                @csrf
                                  <div class="col-12"> 
                                      <label for="inputNISN" class="form-label">NISN</label> 
                                      <input type="number" class="form-control @error('nisn')
                                          is-invalid
                                      @enderror" id="inputNISN" name="nisn" value="{{ old('nisn') }}" required>
                                      @error('nisn')
                                  ...
                                  <div class="col-12"> 
                                      ...
                                      <input type="number" placeholder="08**********" class="form-control @error('no_hp')
                                          is-invalid
                                      @enderror" onKeyPress="if(this.value.length==13) return false;" id="inputNoHp" name="no_hp" value="{{ old('no_hp') }}" required>
                                      @error('no_hp')
                                      <div class="invalid-feedback">
                                        {{ $message }}
                                      </div>
                                  ...
                                  <div class="col-12">
                                      ...
                                      <select id="id_kab" style="width: 100%;" name="id_kab">
                                        <option selected disabled>Pilih Kab/Kot</option>
                                      </select>
                                      @error('id_kab')
                                      <div style="font-size: 14px;" class="text-danger">
                                        {{ $message }}
                                  ...
                                  <div class="col-12">
                                      ...
                                      <div class="form-group other">
                                        ...
                                        <input type="text" class="form-control form-other mb-2" id="usahaLainnya" name="usahaLainnya" data-rule-required="true" contenteditable="false"/>
                                        @error('jenis_usaha')
                                        <div style="font-size: 14px;" class="text-danger">
                                          {{ $message }}
                                        </div>
                                  ...
                                  <div class="col-12">
                                    ...
                                    <div class="form-check other">
                                        ...
                                        <input type="text" class="form-control form-other mb-2" id="tempatLainnya" name="tempatLainnya" data-rule-required="true" contenteditable="false"/>
                                    </div>
                                  ...
                                  <div class="col-12"> 
                                    ...
                                    <input type="number" class="form-control @error('omset')
                                        is-invalid
                                    @enderror" id="inputOmset" name="omset" value="{{ old('omset') }}" required>
                                    @error('omset')
                                    <div class="invalid-feedback">
                                      {{ $message }}
                                    </div>
                                  ...
                                  <div class="col-12">
                                    ...
                                    <input class="form-control @error('foto_produk')
                                        is-invalid
                                    @enderror" type="file" id="formFileFoto" name="foto_produk" accept="image/png, image/jpg, image/jpeg">
                                    @error('foto_produk')
                                    <div class="invalid-feedback">
                                      {{ $message }}
                                    </div>
                                  ...
                                  <div class="modal-footer">
                                      ...
                                      <button type="sumbit" class="btn btn-outline-dark me-1" id="submit"><i class="bi bi-person-check-fill"></i> Tambah Data</button>
                                  </div>
                              </form>
                          </div>
                       </div>
            ...
            <div class="modal fade" id="EditData" tabindex="-1">
              <div class="modal-dialog modal-dialog-scrollable">
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                          <form class="row g-3" action="/disdik/siswa/update" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="col-12">
                            ...
                            <div class="col-12">
                              ...
                              <div class="col-12">
                                ...
                                <input type="text" class="form-control @error('omset')
                                              ...
                                              @enderror" id="inputEditOmset" name="omset" value="{{old('omset')}}" required>
                              ...
                              <div class="col-12">
                                <label for="inputEditLink" class="form-label">Link Produk</label>
                                <input type="url" class="form-control @error('link_produk')
                                                  is-invalid
                                              @enderror" id="inputEditLink" name="link_produk" value="{{ old('link_produk') }}" required>
                                @error('link_produk')
                                <div class="invalid-feedback">
                                  {{ $message }}
                                </div>
                              ...
                              <div class="modal-footer">
                                ...
                                <button type="sumbit" class="btn btn-outline-dark me-1" id="submitEdit"><i class="bi bi-person-check-fill"></i> Ubah Data</button>
                  ...
                  <div class="modal-dialog modal-dialog-centered">
                      <div class="modal-content">
                          ...
                          <div class="modal-body border-upload">
                               <form action="/disdik/import/siswa" method="POST" enctype="multipart/form-data">
                                @csrf
                                  <h4 class="text-center">Pilih file disini</h4>
                                  <p class="text-field text-center">Files Supported: .xls, .xlsx</p>
                                  <input type="file" id="files" name="file_excel" multiple="multiple" class="border-bottom" accept=".xls, .xlsx"/>
              ...
              <div class="modal-dialog modal-dialog-scrollable">
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <h5 class="mt-3 fw-bold">Link Produk: </h5>
                        <a href="" target="_blank" id="linkProduk"></a>
                      </div>
                      <div class="modal-footer">
                          <button type="button" class="btn btn-dark" data-bs-dismiss="modal"><i class="bi bi-arrow-left me-1"></i>Kembali</button> 
                      </div>
      ...
      $.ajax({
          ...
          success:function(response){
            console.log(response[0]);
              ...
              $('#linkProduk').attr('href', response[0].link_produk);
              $('#linkProduk').text(response[0].link_produk);
          }
      });
    }
</script>
