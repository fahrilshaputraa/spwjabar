             ...
             <div class="card-body">
              <div class="header-tabel">
                <div class="row title-table align-items-center">
                  <div class="col">
                    <h5 class="card-title users">Data Admin Sekolah</h5>
                    <p>Semua data users Admin Sekolah!</p>
                  </div>
                  <div class="col btn-tamimport d-flex gap-1 justify-content-end">
                    ...
                    <a href="/admin/export/sekolah" class="btn btn-dark"
                    style="--bs-btn-padding-y: .35rem; --bs-btn-padding-x: 1rem; --bs-btn-font-size: .78rem;">
                ...
                <table class="table datatable border">
                  ...
                  <tbody>
                    ...
                    <tr id="{{ $d->id }}">
                       ...
                       <td class="text-field">{{ $d->level->level }}</td>
                       <td>
        ...
        <form class="row g-3" action="/admin/store" method="POST">
          ...
          <div class="col-12"> 
            ...
            <input type="text" class="form-control @error('name')
                is-invalid
            @enderror" id="inputNama" name="name">
            @error('name')
          ...
          <div class="col-12"> 
            ...
            <input type="text" class="form-control @error('username')
                is-invalid
            @enderror" id="inputUsername" name="username">
            @error('username')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
          ...
          <div class="col-12">
            ...
            <select id="mySelect2" class="form-control form-group @error('kode_user')
                is-invalid
            @enderror" style=" width: 100%;" name="kode_user">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="row g-3" id="formEdit" method="POST">
          ...
          <div class="col-12">
            <label class="form-label">Pilih Instansi</label>
            <select id="EditmySelect2" class="form-control form-group" style=" width: 100%;" name="kode_user">
              <option selected disabled>Pilih Sekolah</option>
              @foreach ($sekolah as $s)
                  <option value="{{ $s->npsn }}">{{ $s->nama_sekolah }}</option>
              @endforeach
            </select>
            <small class="form-text text-muted">*Instansi akan diganti apabila dipilih | Jangan pilih jika tidak ingin diganti</small>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-dark" data-bs-dismiss="modal"><i class="bi bi-arrow-left me-1"></i>Kembali</button> 
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body border-upload">
        <form action="/admin/import/sekolah" method="POST" enctype="multipart/form-data">
          @csrf
